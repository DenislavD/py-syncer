...
def test_copy_items(diff_obj_generator, target_dir):
    execute_filesystem(diff_obj_generator, False, False)
...
def test_replace_items(diff_obj_generator, target_dir, source_dir):
    ...
    execute_filesystem(diff_obj_generator, True, False) # replaces allowed
